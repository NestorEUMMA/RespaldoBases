...
INSERT INTO `examenhemograma` VALUES (1,2,1,NULL,5,2,'2018-10-18','','','','','','','','','','','','','','','','',1),(2,3,1,NULL,5,2,'2018-10-18','Globulos Rojos','Homoglobina','Hematocrito','VGM','HCM','CHCM','LEUCOCITOS','NEUTROFILOS','LINFOCITOS','MONOCITOS','EOSINOFILOS','BASOFILOS','PLAQUETAS','ERITROSE','OTROS','NEUTROFI',1);
...
INSERT INTO `examenorina` VALUES (1,4,3,6,5,2,'2018-10-19','NORMAL','NORMAL','NORMAL','NORMAL','NORMAL','NORMAL','NOARMAL','NORMAL','NORMAL','NOARMAL','NORMAL','NORMAL','','','','','','','',1);
...
INSERT INTO `listaexamen` VALUES (1,4,1,2,2,0,'2018-10-18','General de Heces'),(2,5,NULL,2,1,0,'2018-10-18','Examen General '),(3,5,NULL,2,1,0,'2018-10-18','examen'),(4,7,6,2,3,0,'2018-10-19','GENERAL DE ORINA'),(5,4,7,2,1,1,'2018-10-19','LEOCOGRAMA'),(15,4,9,2,3,1,'2019-01-10','Examen de orina esta es otra prueba'),(16,4,9,2,1,1,'2019-01-10','Examen Hemograma Prueba'),(17,4,9,2,4,1,'2019-01-10','Examen Quimico'),(18,4,9,2,5,1,'2019-01-10','Examen Varios');
...
INSERT INTO `menu` VALUES (1,'ADMIN USUARIOS','fa fa-user-o','Menu'),(2,'ADMIN MEDICOS','fa fa-stethoscope','Menu'),(3,'SOCIOECONOMICO','fa fa-dollar','Menu'),(4,'MANTENIMIENTO','fa fa-database','Menu'),(5,'RECEPCION','fa fa-medkit','Menu'),(6,'ENFERMERIA','fa fa-medkit','Menu'),(7,'CONSULTA MEDICA','fa fa-medkit','Menu');
...
INSERT INTO `menudetalle` VALUES (1,1,'USUARIOS','../usuario/index','fa fa-user-circle-o'),(2,1,'PUESTO','../puesto/index','fa fa-briefcase'),(3,2,'ENFERMED','../enfermedad/index','fa fa-archive'),(4,2,'MODULO','../modulo/index','fa fa-bookmark-o'),(5,2,'DIAGNOSTIC','../tipodiagnostico/index','fa fa-book'),(6,3,'PREGUNTAS','../pregunta/index','fa fa-arrows-h'),(7,3,'RESPUESTA','../respuesta/index','fa fa-arrows-v'),(8,3,'FACTOR','../factor/index','fa fa-asterisk'),(9,4,'GEOGRAFIA','../geografia/index','fa fa-arrows-alt'),(10,4,'PAIS','../pais/index','fa fa-arrows'),(11,4,'EST CIVIL','../estadocivil/index','fa fa-check-square-o'),(12,1,'MENU','../menu/index','fa fa-cog'),(13,1,'SUBMENU','../menudetalle/index','fa fa-cogs'),(14,1,'PERMISOS','../menuusuario/index','fa fa-crop'),(15,5,'PACIENTES','../persona/index','fa fa-users'),(16,5,'CONSULTA','../consultapaciente/index','fa fa-medkit'),(17,6,'CONSULTA','../enfermeriaconsulta/index','fa fa-medkit'),(18,6,'PROCEDIM','../enfermeriaprocedimiento/index','fa fa-heart'),(19,7,'CONSULTA','../consultamedico/index','fa fa-medkit');
...
INSERT INTO `menuusuario` VALUES (1,1,'1',1,1,1),(2,2,'1',1,1,1),(3,3,'1',1,2,1),(4,4,'1',1,2,1),(5,5,'1',1,2,1),(6,6,'1',1,3,1),(7,7,'1',1,3,1),(8,8,'1',1,3,1),(9,9,'1',1,4,1),(10,10,'1',1,4,1),(11,11,'1',1,4,1),(12,12,'1',1,1,1),(13,13,'1',1,1,1),(14,14,'1',1,1,1),(15,15,'1',1,5,1),(16,16,'1',1,5,1),(17,17,'1',1,6,1),(18,18,'1',1,6,1),(19,19,'1',1,7,1);
...
INSERT INTO `modulo` VALUES (3,'Pediatria','Modulode Pediatria',''),(4,'Laboratorio','Modulo de Laboratorio',''),(5,'Enfermeria','Modulo de Enfermeria',''),(6,'Medicina General','Modulo de Medicina General',''),(7,'Ginecologia','Modulo de Ginecologia','');
...
INSERT INTO `pregunta` VALUES (1,1,'Profesional','Profesional',0,'1'),(2,1,'Posee trabajo','Posee trabajo',0,'1'),(3,1,'Su cónyuge es profesional','Su cónyuge es profesional',0,'1'),(4,1,'Cúantos hijos tiene','Cúantos hijos tiene',0,'1'),(5,1,'Tiene familiares viviendo en el extranjero, le envían ayuda','Tiene familiares viviendo en el extranjero, le envían ayuda',0,'1'),(6,1,'Su familia posee vehículo o moto','Su familia posee vehículo o moto',0,'1'),(7,1,'Tipo de vivienda','Tipo de vivienda',0,'1'),(8,1,'Número de personas que vivien en la vivienda','Número de personas que vivien en la vivienda',0,'1'),(9,1,'Poseen televisor','Poseen televisor',0,'1'),(10,1,'Poseen refrigeradora','Poseen refrigeradora',0,'1'),(11,1,'Su vivienda tiene agua potable','Su vivienda tiene agua potable',0,'1'),(12,1,'Su vivienda tiene energía eléctrica','Su vivienda tiene energía eléctrica',0,'1'),(13,1,'Alquilan o son dueños de su vivienda','Alquilan o son dueños de su vivienda',0,'1'),(14,2,'Alergias a Medicamentos','Alergias a Medicamentos',1,'1'),(15,2,'Alergias a Medicamentos u otros elementos','Alergias a Medicamentos u otros elementos',1,'1'),(16,2,'Medicamentos que esta tomando actualmente','Medicamentos que esta tomando actualmente',1,'1'),(17,2,'Por favor indique si padece alguna de estas enfermedades ahorita en el pasado','Por favor indique si padece alguna de estas enfermedades ahorita en el pasado',2,'1'),(18,2,'Ha recibido alguna cirugia?','Ha recibido alguna cirugia?',1,'1'),(19,2,'El paciente toma alcohol','El paciente toma alcohol',0,'1'),(20,2,'El paciente fuma?','El paciente fuma?',0,'1'),(21,2,'Si el paciente fumo en el pasado. Cuando dejo de fumar?','Si el paciente fumo en el pasado. Cuando dejo de fumar?',1,'1'),(22,2,'Nivel de Ejercicio','Nivel de Ejercicio',0,'1'),(23,2,'Historial de Abuela Maternal','Historial de Abuelo Materno',2,'1'),(24,2,'Historial de Abuelo Maternal','Historial de Abuelo Materno',2,'1'),(25,2,'Historial de Abuela Paternal','Historial de Abuelo Materno',2,'1'),(26,2,'Historial de Abuelo Paternal','Historial de Abuelo Materno',2,'1'),(27,2,'Historial de Padre','Historial de Abuelo Materno',2,'1'),(28,2,'Historial de Madre','Historial de Abuelo Materno',2,'1'),(29,2,'Siente depresion y falta de interes en la vida?','Siente depresion y falta de interes en la vida?',0,'1'),(30,2,'En alguna vez ha pensado en quitarse la vida (Suicidarse)?','En alguna vez ha pensado en quitarse la vida (Suicidarse)?',0,'1'),(31,3,'Esquema de Vacunación','Esquema de Vacunación',2,'1');
...
INSERT INTO `usuario` VALUES (1,'Administrador','Nestor ','Ulloa','correo@corre.com','827ccb0eea8a706c4c34a16891f84e7b',1,1,'2016-08-01','1','uploads/usuarios/admin.jpg'),(2,'Recepcion','Nestor','Ulloa','nestor.ulloa@gentenoble.org','827ccb0eea8a706c4c34a16891f84e7b',1,6,'2018-10-10',NULL,NULL),(3,'Enfermeria','Miranda','Ulloa','miranda.ulloa@mail.com','827ccb0eea8a706c4c34a16891f84e7b',1,5,'2018-10-16',NULL,NULL),(4,'Medico','David','Marroquin','david.marroquin@mail.com','827ccb0eea8a706c4c34a16891f84e7b',1,2,'2018-10-16',NULL,NULL),(5,'laboratorio','Josue','Marroquin','josue.marroquin@mail.com','827ccb0eea8a706c4c34a16891f84e7b',1,3,'2018-10-18',NULL,NULL),(6,'Medico2','Katya ','Quinteros','katya.quinteros@mail.com','827ccb0eea8a706c4c34a16891f84e7b',1,2,'2018-10-18',NULL,NULL),(7,'medico3','William','Castro','william.castro@mail.com','827ccb0eea8a706c4c34a16891f84e7b',1,2,'2018-10-18',NULL,NULL);
...
-- Dump completed on 2019-01-10 17:03:29
